...
#Include Lib\Lib_SQL.AHK
	...
	; mguiConvertServer := GUI()
	; mCBValue := mguiConvertServer.AddCheckbox("vCBFormat","Gentax Format?")
	; mbtnInput := mguiConvertServer.AddButton("Default v","Input")
	; mbtnInput.OnEvent("Click",ConvertServerButtonInput)
...
; {
	...
	; {
		...
		; ; 2 - GentaxEnvironments.ini exists and is populated with values for each envi in tblDataBase
		; strEnv :=""
