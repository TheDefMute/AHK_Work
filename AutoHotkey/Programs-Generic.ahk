...
^!N::		;Program - Notepad++
{
	Run Globals.GetIniValue("Programs.ini","ProgramRun","NotepadPP")
}
	
^!S::		;Program - Sticky Notes
{
	Run Globals.GetIniValue("Programs.ini","ProgramRun","StickyNotes")
}
...
^!O::	;Program - One Note
{
	Run  Globals.GetIniValue("Programs.ini","ProgramRun","OneNote")
}
;------------------------------------------
